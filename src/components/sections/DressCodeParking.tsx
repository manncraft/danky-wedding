  ...
  return (
    <section className="flex-1 flex flex-col sm:flex-row-reverse items-stretch gap-8 sm:gap-12 py-8 px-6 sm:px-0">
      ...
      <div className="flex-1 self-center flex flex-col gap-12">
        <div id="dress-code" className="border border-white/25 px-4 p-4 text-center">
        ...
        <div id="parking-transportation" className="border border-white/25 px-4 p-4 text-center">
        ...
        <div id="gifts" className="border border-white/25 px-4 p-4 text-center">
          <p className="text-base font-bold uppercase tracking-widest mb-2">Gifts</p>
          <p className="text-lg">Your company on our special day is all we need. However, should you wish to contribute to our honeymoon, we will have a wishing well at the venue.</p>
        </div>
      </div>
